...
A 3D model of the super-attenuator is depicted in \fref{fig:superattenuator}. The first stage is an inverted pendulum platform providing isolation at very low frequencies (about 30\,mHz) and actuation capabilities for coarse alignment and compensation of tidal effects.
...
\begin{figure}
	...
	\caption{A 3D model of the Virgo superattenuator (figure from \cite{Accadia_2012})}
\label{fig:superattenuator}\end{figure}
...
\caption{The optical layouts of the core interferometers of Advanced LIGO and Advanced Virgo (left), and GEO600 (right). 
...
\label{fig:detector_layouts}\end{figure}
