...
%ISSUE: should we comment on the fact that first/second/future classification is in some cases a bit arbitrary?
%ISSUE: should we explicitly comment on the fact that we use LIGO as a reference?
...
%TODO: add a few details on superattenuator here
